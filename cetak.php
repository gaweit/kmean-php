...
<div class="widget-header"> <i class="icon-list-alt"></i>
              <h2 align="center"> Hj.Mbok Sri Kota Palu</h2>
			  <p align="center">Laporan Hasil Clustering</p>
			  <p align="center">KLASIFIKASI PRODUK MENGGUNAKAN METODE CLUSTERING K-MEANS DALAM PENENTUAN STOK PRODUK PADA UKM MUTIARA KOTA PALU DIMASA PANDEMI COVID-19 </p>
			  <hr/>
            </div>
            <!-- /widget-header -->
